...
public sealed class RestoreBookCommandHandler(
    ...
    IDateTimeProvider clock) : ICommandHandler<RestoreBookCommand>
{
    public async Task<Result> Handle(
        RestoreBookCommand request, CancellationToken cancellationToken)
    {
        ...
        var result = book.Restore(clock.UtcNow);
