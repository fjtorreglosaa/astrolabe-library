...
public sealed class RemoveBookCommandHandler(
    ...
    IDateTimeProvider clock) : ICommandHandler<RemoveBookCommand>
{
    public async Task<Result> Handle(
        RemoveBookCommand request, CancellationToken cancellationToken)
    {
        ...
        var result = book.Remove(request.Reason, request.Notes, clock.UtcNow);
