...
> **PLACEHOLDER.** The task list is authored at the start of PLAN-001 Stage 3, once
> `reservations.business.md` and `reservations.technical.md` exist.
...
Task IDs follow `RSV-{NNN}`.

| ID | Task | Status | Blocker | Tracking | Notes |
|---|---|---|---|---|---|
| `RSV-001` | *To be authored.* | ⬜ | — | — | |
