...
**Implements:** *to be listed once `reservations.business.md` defines its `BR-RSV-*` rules*

> **PLACEHOLDER.** This file carries every required section with guidance on what belongs in each.
> It is authored **after** `reservations.business.md`, per SDD+ Principle 2 — you cannot make a good
