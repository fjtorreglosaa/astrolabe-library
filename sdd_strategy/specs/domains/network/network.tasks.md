...
| `NET-025` | Replace `UnimplementedLibraryObligationsProbe` with real queries | ⬜ | — | — | **BR-NET-005 is only half enforced until this lands.** The home-library guard works; the obligations guard always answers "none". Needs `catalog`, `reservations` and `billing` |
