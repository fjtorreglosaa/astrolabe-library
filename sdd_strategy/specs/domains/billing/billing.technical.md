...
**Implements:** *to be listed once `billing.business.md` defines its `BR-BIL-*` rules*

> **PLACEHOLDER.** This file carries every required section with guidance on what belongs in each.
> It is authored **after** `billing.business.md`, per SDD+ Principle 2 — you cannot make a good
