...
**Implements:** *to be listed once `notifications.business.md` defines its `BR-NTF-*` rules*

> **PLACEHOLDER.** This file carries every required section with guidance on what belongs in each.
> It is authored **after** `notifications.business.md`, per SDD+ Principle 2 — you cannot make a good
