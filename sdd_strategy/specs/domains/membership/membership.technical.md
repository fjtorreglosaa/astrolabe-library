...
**Implements:** *to be listed once `membership.business.md` defines its `BR-MBR-*` rules*

> **PLACEHOLDER.** This file carries every required section with guidance on what belongs in each.
> It is authored **after** `membership.business.md`, per SDD+ Principle 2 — you cannot make a good
