...
**Implements:** *to be listed once `recommendations.business.md` defines its `BR-REC-*` rules*

> **PLACEHOLDER.** This file carries every required section with guidance on what belongs in each.
> It is authored **after** `recommendations.business.md`, per SDD+ Principle 2 — you cannot make a good
