...
> **PLACEHOLDER.** The task list is authored at the start of PLAN-001 Stage 7, once
> `recommendations.business.md` and `recommendations.technical.md` exist.
...
Task IDs follow `REC-{NNN}`.

| ID | Task | Status | Blocker | Tracking | Notes |
|---|---|---|---|---|---|
| `REC-001` | *To be authored.* | ⬜ | — | — | |
