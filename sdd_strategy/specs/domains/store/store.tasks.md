...
> **PLACEHOLDER.** The task list is authored at the start of PLAN-001 Stage 5, once
> `store.business.md` and `store.technical.md` exist.
...
Task IDs follow `STR-{NNN}`.

| ID | Task | Status | Blocker | Tracking | Notes |
|---|---|---|---|---|---|
| `STR-001` | *To be authored.* | ⬜ | — | — | |
