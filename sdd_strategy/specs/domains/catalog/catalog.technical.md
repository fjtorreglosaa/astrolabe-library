...
**Implements:** *to be listed once `catalog.business.md` defines its `BR-CAT-*` rules*

> **PLACEHOLDER.** This file carries every required section with guidance on what belongs in each.
> It is authored **after** `catalog.business.md`, per SDD+ Principle 2 — you cannot make a good
